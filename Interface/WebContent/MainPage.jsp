...
<div class="w3-col l8 s12">
  ...
  <div class="w3-card-4 w3-margin w3-white">
    ...
    <div class="w3-container">
      <h3><b>Saisissez la référence de votre produit</b></h3>	  
  ...
  <div class="w3-card w3-margin">
    ...
    <ul class="w3-ul w3-hoverable w3-white">
	  ...
	  <li class="w3-padding-16">
		...
		<a class="w3-large" href="https://fr.gant.com/homme-polos/blanc-polo-en-coton-piqu%C3%A9/33979?gclid=Cj0KCQiAgomBBhDXARIsAFNyUqPsKWbQhypnAGmLOGvqhXNO9tmNqa55rFL-Z2nun77R3iHnqXtuO3oaAubpEALw_wcB" target="blank"><b>Polo en coton piqué</b></a><br>
        <span><b>Pour un côté sportif</b></span>
      </li>
