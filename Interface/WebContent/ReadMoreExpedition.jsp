...
<div class="w3-col l8 s12">
  ...
  <div class="w3-card-4 w3-margin w3-white">
    ...
    <div class="w3-container">
	  ...
	  solutions adaptées à nos produits.<br>Dans un souci constant de minimisation de l'impact négatif de nos emballages sur l'envrionnement,
	  notre politique d'emballage met l'accent sur l'utilisation de matériaux 
	  ...
	  Des projets relatifs à l'augmentation des taux de remplissage sont également en cours.</p>
	  <p></p>
    </div>
  </div>
  <hr>
